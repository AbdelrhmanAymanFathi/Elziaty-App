      ...
      $.ajax({
        ...
        success: function(res) {
          ...
          suggestions.forEach(assoc => {
            ...
            // Build card
            const $card = $(`
              <div class="max-w-md mx-auto bg-white border rounded-2xl shadow p-4 text-right font-sans" data-id="${assoc.id}">
      ...
      $.ajax({
        ...
        success: function(res) {
          ...
          associations.forEach(assoc => {
            ...
            const $card = $(`
              <div class="max-w-md mx-auto bg-white border rounded-2xl shadow p-4 text-right font-sans">
